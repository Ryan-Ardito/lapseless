...
export function createSeedPTOData(): PTOEntry[] {
  ...
  return [
    { id: crypto.randomUUID(), date: dateInCurrentYear(1, 1), hours: 8, type: 'holiday', notes: "New Year's Day", createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(1, 20), hours: 8, type: 'holiday', notes: 'MLK Day', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(2, 17), hours: 8, type: 'holiday', notes: "Presidents' Day", createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(5, 26), hours: 8, type: 'holiday', notes: 'Memorial Day', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(4, 14), hours: 8, type: 'vacation', notes: 'Spring getaway day 1', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(4, 15), hours: 8, type: 'vacation', notes: 'Spring getaway day 2', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(7, 3), hours: 8, type: 'vacation', notes: 'Summer day off', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(3, 10), hours: 8, type: 'sick', notes: 'Flu', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(6, 5), hours: 4, type: 'sick', notes: 'Doctor appointment (half day)', createdAt: now },
    { id: crypto.randomUUID(), date: dateInCurrentYear(5, 2), hours: 8, type: 'personal', notes: 'Moving day', createdAt: now },
  ];
}
